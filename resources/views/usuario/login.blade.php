                    ...
                    <div class="card border-primary">
                        <div class="card-body">
                            ...
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="row mb-3">
                                    <a href="#resetsenha" class="btn btn-link" rel="modal:open">Esqueci minha senha</a>
                                </div>
    ...
    <div class="modal custom-modal" id="form-cadastro">
        ...
        <form class="form-horizontal form-ajax noenter" id="form-cadastro" enctype="multipart/form-data" method="post">
            ...
            <div class="form-group text-center">
                <button type="submit" id="send-cadastro" class="btn btn-primary btn-block"><i class="fa fa-check"></i> Cadastrar</button>
            </div>
        </form>
    </div>
