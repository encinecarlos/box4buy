                        ...
                        <div class="box-body">
                            <div class="form-group notMarging">                                
                                <div class="form-group notMarging">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="inputNome" name="_nome" placeholder="Nome" type="text" value="{{ $pessoa->nome_completo }}">                                        
                                    </div>
                                ...
                                <div class="form-group notMarging">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control pull-right" id="datepicker" name="data_nascimento" placeholder="dd/mm/aaaa" type="date" value="{{ $pessoa->data_nascimento }}">
                                    </div>
                                    <label class="col-sm-1 control-label" for="inputEmail">
                                        Email
                                    </label>
                                    <div class="col-sm-4">
                                        <input class="form-control" id="inputEmail" name="email" placeholder="Email" type="email" value="{{ $pessoa->email }}">
                                ...
                                <div class="form-group notMarging">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control" id="inputCPF" name="cpf_cnpj" placeholder="CPF" type="text" value="{{ $pessoa->cpf_cnpj }}">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control" id="inputCPF" name="rg_ie" placeholder="RG" type="text" value="{{ $pessoa->rg_ie }}">
                                ...
                                <div class="form-group notMarging">
                                    ...
                                    <div class="col-sm-4">
                                        <input class="form-control" data-inputmask='"mask": "(99) 999-9999"' data-mask="" name="telefone_01" placeholder="Telefone 02" type="text" value="{{ $contato[0]['telefone_01'] }}">
                                ...
                                <br>
                                    <div class="form-group notMarging">
                                        ...
                                        <div class="col-sm-4">                                            
                                            <a href="#modalAddEndereco" rel="modal:open" data-method="add" class="btn btn-info boxColorTema">Adicionar Endereço</a>
                                        </div>
                                        <label class="col-sm-2 control-label" for="inputAdicionaEdereco">
                                            Editar endereço
                                        </label>
                                        <div class="col-sm-4">
                                            <a href="#modalEndereco" rel="modal:open" data-method="edit" class="btn btn-info boxColorTema">Editar Endereço</a>
                                        </div>
                                        
                                    </div>                                    
                                        <div class="form-group notMarging">
                                            {{-- <div class="col-sm-2 col-sm-offset-2">
                                                <a class="btn btn-info boxColorTema" data-target="#upload-modal" data-toggle="modal" href="#" id="inputValida">
                                                    <i class="fa fa-check">
                                                    </i>
                                                    VALIDAR CONTA
                                                </a>
                ...
                <div class="tab-pane" id="documentos">                    
                    <div class="row">                                                
                        @if($documentos[0]->caminho_rg == null && $documentos[0]->caminho_comprovante == null)
                            <div class="col-sm-12">
                                <p class="alert alert-warning text-uppercase text-center">nenhum documento enviado!</p>
                            </div>
                        @else
                             @foreach ($documentos as $documento)
                                <div class="col-sm-6">
                                    <img class="img-responsive img-thumbnail" src="{{ $documento->caminho_rg }}" alt="Documento de identificação">
                                    <button class="btn btn-danger removedoc" data-documento="rg" onclick="removedocumento({{ $pessoa->codigo_suite }})"><i class="fa fa-trash"></i></button>
                                </div>
                                <div class="col-sm-6">
                                    <img class="img-responsive img-thumbnail" src="{{ $documento->caminho_comprovante }}" alt="Comprovante de residencia">
                                    <button class="btn btn-danger removedoc" data-documento="comprovante" onclick="removedocumento({{ $pessoa->codigo_suite }})"><i class="fa fa-trash"></i></button>
                                </div>
                            @endforeach
                        @endif    
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-success enablepayment" id="{{ $pessoa->codigo_suite }}"><i class="fa fa-check"></i> Liberar</button>
                            <button type="button" class="btn btn-danger disablepayment" id="{{ $pessoa->codigo_suite }}"8><i class="fa fa-check"></i> Bloquear</button>
                        </div>
                    </div>
                </div>
            </div>
