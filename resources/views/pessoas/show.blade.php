            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="documentos">
                        <div class="row">
                            @if($documentos[0]->caminho_rg == '' && $documentos[0]->caminho_comprovante == '')
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="box box-info">
                                            <div class="box-header">
                                                <h4>Documento 01</h4>
                                                <div class="box-tools">
                                                    <button class="btn btn-danger btn-rounded removedoc" data-documento="rg"
                                                            onclick="removedocumento({{ $pessoa->codigo_suite }})">
