                        ...
                        <form class="form-horizontal" action="#" method="post" id="form-add-cliente">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputnomeCompleto" name="nome"
                                               value="Nome" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control pull-right" id="datepicker" name="data"
                                               value="Data" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputSexo" name="sexo" value="sexo"
                                               required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEstadoCivil" name="civil"
                                               value="estado civil" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" id="inputNumero" name="numero"
                                               placeholder="Número" value="numero" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="inputCidade" name="cidade"
                                               placeholder="Cidade" value="cidade" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="inputBairro" name="estado"
                                               value="estado" required>
                                    </div>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="inputComplemento"
                                               placeholder="Complemento" name="complemento" value="complemento">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="inputPais" name="pais" value="pais"
                                               required>
                                    </div>
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="inputCEP" placeholder="CEP"
                                               name="cep" value="cep" required>
                                    </div>
                                </div>
                            </div>
